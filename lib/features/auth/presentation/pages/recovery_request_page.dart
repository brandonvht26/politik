...
class RecoveryRequestPage extends StatefulWidget {
  const RecoveryRequestPage({super.key});
...
class _RecoveryRequestPageState extends State<RecoveryRequestPage> {
  ...
  void _requestRecovery() {
    ...
    context.read<AuthBloc>().add(
          PasswordRecoveryRequested(cedula: _cedulaCtrl.text.trim()),
        );
  }
                    ...
                    if (state is PasswordRecoverySent) {
                      return Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 16),
                          Text(
                            'Hemos enviado un enlace de recuperación al correo electrónico asociado a tu cuenta. Por favor revisa tu bandeja de entrada o spam.',
                    ...
                    return Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Ingresa tu número de cédula para enviarte un enlace de recuperación.',
                            style: theme.textTheme.bodyMedium?.copyWith(
                            ...
                            builder: (context) {
                              ...
                              return Container(
                                ...
                                child: FilledButton.icon(
                                  onPressed: isLoading ? null : _requestRecovery,
                                  icon: isLoading
                                      ? const SizedBox(
                                          width: 20,
                                          height: 20,
